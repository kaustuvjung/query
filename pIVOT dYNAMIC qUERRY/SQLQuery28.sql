...
Drop Table #RawData
Drop Table #FinalData',N'@AssetId nvarchar(22),@wardNo int,@RowParameterKey nvarchar(7),@ColumnParameterKey nvarchar(4000)',@AssetId=N'aCPTaKvZYQGBekbMRq4tEk',@wardNo=0,@RowParameterKey=N'H_caste',@ColumnParameterKey=NULL